    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent>
        ...
        <div className="mt-6 space-y-4 w-full">
          <DetailItem icon={Clock} label={tHistoryPageTable('date')} value={formatDateHourMinute(Number(create_at))} />
          <DetailItem icon={CreditCard} label={tHistoryPageTable('currency')} value={currency} />
          <DetailItem
            icon={Tag}
          ...
          />
          {network !== '' && (
            <DetailItem icon={Globe} label={tHistoryPageTable('network')} value={network} valueClassName="capitalize" />
          )}
          {tx_hash && (
            <DetailItem
              icon={Hash}
          ...
          {note && <DetailItem icon={FileText} label={tHistoryPageTable('note')} value={note} />}
          {hasImage && (
