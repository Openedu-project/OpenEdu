...
export default async function LaunchpadSection() {
  ...
  const FeatureCard = ({ feature }: { feature: Feature }) => (
    <div className="flex items-start gap-3 rounded-2xl bg-white/50 p-3 backdrop-blur-xs transition-shadow hover:shadow-lg md:gap-6 md:p-4">
      <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-ai-feature-gradient">
      ...
      <div>
        ...
        <p className="mcaption-regular12 lg:mcaption-regular16">{feature.description}</p>
      </div>
    </div>
  );
    ...
    <div className="relative mt-10 w-full rounded-[40px] bg-launchpad-gradient pt-16">
      ...
      <div className="container relative z-10 mx-auto px-4 pb-4 md:pb-12">
        <div className="mt-10 text-center">
          ...
          <p className="mcaption-regular20 md:mcaption-regular24 mb-6">{t('subtitle')}</p>
