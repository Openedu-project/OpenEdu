    ...
    <section className="relative w-full overflow-hidden rounded-3xl bg-learning-gradient shadow-[0px_4px_10px_0px_#FFF_inset] backdrop-blur-lg">
      <div className="container relative z-10 mx-auto p-5 md:p-10">
        <div className="mb-8 text-center md:mb-10">
          <h2 className="giant-iheading-bold20 md:giant-iheading-bold24 lg:giant-iheading-bold32 mb-5">{t('title')}</h2>
          <p className="mcaption-regular16 lg:mcaption-regular24 mx-auto max-w-[85%]">{t('description')}</p>
        </div>
          ...
          <div className="flex flex-col">
            <h3 className="giant-iheading-bold20 md:giant-iheading-bold24 lg:giant-iheading-bold28 mb-6 text-center md:mb-8">
              {t.rich('earnCertificate', {
                span: chunks => (
                  <span className="bg-gradient-to-br from-turquoise-500 via-violet-500 to-violet-500 bg-clip-text text-transparent">
                    {chunks}
                  </span>
                ),
              })}
          ...
          <div className="flex flex-col lg:h-full">
            ...
            <div className="grid flex-1 grid-cols-1 gap-16 md:grid-cols-2 md:gap-16 lg:gap-4">
              {TESTIMONIALS?.map(testimonial => (
                <div
                  className="mt-12 flex flex-col rounded-lg bg-white p-6 pt-12 md:mt-12 lg:mt-0"
                  key={testimonial.id}
                >
                  ...
                  <div className="mt-2 mb-4 text-center">
                    <h4 className="mcaption-bold14 md:mcaption-bold16 mb-1">{testimonial.author}</h4>
                    <p className="mcaption-regular14 md:mcaption-regular16">{testimonial.role}</p>
                  </div>
                  <p className="mcaption-regular14 text-center">{testimonial.quote}</p>
