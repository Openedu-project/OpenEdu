          ...
          <div className="flex flex-col lg:h-full">
            ...
            <div className="grid flex-1 grid-cols-1 gap-16 md:grid-cols-2 md:gap-16 lg:gap-4">
              {TESTIMONIALS?.map(testimonial => (
                <div
                  className="relative mt-12 flex flex-col rounded-lg bg-white p-6 pt-12 md:mt-12 lg:mt-0"
                  key={testimonial.id}
                >
                  <div className="-top-8 -translate-x-1/2 absolute left-1/2 h-[80px] w-[80px] rounded-full bg-white p-0.5">
                    <Image
