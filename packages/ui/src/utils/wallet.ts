...
import { TChainData } from '@oe/api/types/wallet';
import { CHAIN, CURRENCY_SYMBOLS, TChain, TCurrencySymbol } from '@oe/api/utils/wallet';
import type { StaticImageData } from 'next/image'; import availLogo from '@oe/assets/images/icons/avail-icon.png';
