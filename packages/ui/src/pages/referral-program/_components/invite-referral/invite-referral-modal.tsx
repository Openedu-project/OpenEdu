import { AUTH_ROUTES, buildUrl, copyToClipboard, getCookieClient } from '@oe/core';
...
export function InviteReferralModal({
  open,
  onClose,
  refCode,
}: {
  ...
  const savedLang = (getCookieClient(process.env.NEXT_PUBLIC_COOKIE_LOCALE_KEY) as LanguageCode) ?? 'en';
