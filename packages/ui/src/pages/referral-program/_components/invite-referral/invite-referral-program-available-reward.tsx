...
const RewardCard = ({
  ...
  <Card className="relative overflow-hidden rounded-[12px] border-none bg-base-cool">
    <CardContent className="p-4">
      ...
      <p className="mbutton-regular16 text-center md:text-left">
        {description}
      </p>
    </CardContent>
  </Card>
    ...
    <section className="mb-6 block rounded-[16px] bg-white p-2 md:p-6">
      ...
      <div className="mb-6">
        <div className="mb-2 flex flex-col items-center justify-between md:flex-row">
          <h3 className="mcaption-semibold18 md:mcaption-semibold24 text-center md:text-left">
            {t("title")}
          </h3>
        ...
        <p className="mbutton-regular16 mb-4 text-center md:text-left">
          {t("subtitle")}
        </p>
      </div>
