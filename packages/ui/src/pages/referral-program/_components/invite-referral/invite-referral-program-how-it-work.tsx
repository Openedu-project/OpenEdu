...
import IconSend2 from '@oe/assets/icons/referral-program/icon-send-2';
import IconSmsEdit from '@oe/assets/icons/referral-program/icon-sms-edit';
...
const Step = ({ icon: Icon, title, description }: StepProps): JSX.Element => (
  <div className="flex flex-col items-center text-center">
    ...
    <h3 className="mcaption-semibold16 md:mcaption-semibold20 mb-1 sm:mb-2">{title}</h3>
    <p className="mcaption-regular14 md:mbutton-regular16 leading-tight">{description}</p>
  </div>
);

export default async function InviteReferralProgramHowItWork(): Promise<JSX.Element> {
