...
const PaymentConfirm = ({
  ...
  const isIncluded =
    has_certificate || quiz_count > 0 || active_section > 0 || video_count > 0;
  ...
  const handleRedirect = (
    ...
    if (typeof window !== "undefined") {
      ...
      if (domain && domain !== window.location.hostname) {
        window.open(
          `https://${domain}${PLATFORM_ROUTES.courses}/${slug}`,
          "_blank"
        );
      } else {
  ...
  return (
    <div className="mb-4 md:mb-8">
      <div className="mb-6 flex items-center justify-between">
        <h2 className="giant-iheading-semibold28">
          {tCoursePayment("coursePayment")}
        </h2>
        {supportChannel && (
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                  ...
                                  <span className="mcaption-semibold16">
                                    {method?.name}
                                  </span>
                                </div>
                                {method?.amount && (
                                  <span className="mcaption-regular16 text-neutral-900">
                                    {method?.amount}
                                  </span>
                                )}
                              </div>
                ...
                >
                  ...
                  <CardContent className="flex basis-full flex-col gap-3 p-0 text-foreground">
                    ...
                    <div className="mcaption-regular16 mb-2 flex items-center gap-1">
                      <CalendarClock className="h-[17px] w-[16px] text-neutral-900" />
                      <span>
                      ...
                      <div className="flex flex-wrap gap-5">
                        <div className="flex items-center gap-1">
                          ...
                          <span>
                            ...
                            {courseData?.learner_count &&
                            courseData?.learner_count > 1
