...
export function PaymentSuccess() {
  ...
  const { course: courseOutlineData, mutateCourse: mutateCourseOutline } = useGetCourseOutline(slug as string);
  ...
  return (
    <Card className="mx-auto my-12 w-full text-center md:w-[440px]">
      <CardContent className="pt-6">
        ...
        <p className="mcaption-regular14 mb-6 text-neutral-900">{t('message')}</p>
        ...
        <div className="mt-6 flex justify-center space-x-4">
          ...
          <Link
            ...
            className={cn(buttonVariants({ variant: 'default' }), 'max-w-[200px] text-primary-foreground')}
          >
            {t('button')}
          </Link>
        </div>
