...
const StepCard = ({ data }: StepCardProps) => {
  return (
    <div className="flex min-h-0 flex-col items-center justify-center gap-2 rounded-3xl border-4 border-white bg-[linear-gradient(180deg,_#FFF_25%,_#F2F1FF_80%)] p-4 backdrop-blur-[2px] sm:gap-3 sm:p-6 md:min-h-[400px] md:gap-4 lg:px-8">
