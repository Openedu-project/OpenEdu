...
const HowToCard = ({ data }: { data: THowToGetMoney }) => {
  return (
    <div className="flex flex-col items-start justify-start space-y-4 rounded-3xl bg-gradient-to-b bg-white from-34% from-white via-primary-20/30 to-primary-20/30 leading-[125%] shadow-[0px_4px_30px_0px_rgba(193,195,251,0.30)] backdrop-blur-sm transition-all hover:scale-[102%] sm:flex-row sm:items-center">
