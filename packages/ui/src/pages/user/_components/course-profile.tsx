...
export default function CourseProfile({ className, courseData, mutate, isSetting, ...props }: ICourseCard) {
      ...
      <>
        ...
        <div className="relative flex w-full items-center justify-between">
          <div className="flex items-center gap-[10px]">
            {is_pay ? (
              <>
                <p className="mcaption-bold16 text-[#424242]">
              ...
              <p className="mcaption-bold16 text-[#424242]">FREE</p>
            )}
          </div>
          <WishlistButton
