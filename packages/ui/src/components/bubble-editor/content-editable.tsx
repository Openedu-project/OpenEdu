...
import { createElement, forwardRef, memo, useEffect, useMemo, useRef } from 'react';

import type { FocusEvent, ForwardedRef, HTMLAttributes, KeyboardEvent, SyntheticEvent } from 'react';
...
export const ContentEditable = memo(
  forwardRef(
    ({ className, disabled, tagName, value = '', ...rest }: ContentEditableProps, ref: ForwardedRef<HTMLElement>) => {
