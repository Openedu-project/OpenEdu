...
export const NewUserSignInTriggerModal = () => {
  ...
  const { dataNewUserSignIn } = useGetNewUserSignIn(
    Boolean(dataMe && !dataMe?.new_user_survey_completed)
  );
  useEffect(() => {
  ...
  return (
    ...
    dataNewUserSignIn && (
      <FormRendererSlideModal
        ...
        onClose={() =>
          setOpenTriggerModal(MODAL_ID.newUserSignInFormTrigger, false)
        }
