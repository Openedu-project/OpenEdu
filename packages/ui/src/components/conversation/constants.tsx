...
export const AI_SIDEBAR: (color?: string, size?: number) => AISidebarItem[] = (color, size = 12) => [
  {
    ...
    value: 'chat',
    href: AI_ROUTES.chat,
    icon: <MessageCircle size={size} color={color ?? 'hsl(var(--warning-500))'} />,
  ...
  },
  {
    ...
    icon: <Grid3 width={size} height={size} color={color ?? 'hsl(var(--info-500))'} />,
  ...
  },
  {
    ...
    icon: <Gallery width={size} height={size} color={color ?? 'hsl(var(--pink-500))'} />,
