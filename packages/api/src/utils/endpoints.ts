export const API_ENDPOINT = {
  ...
  COURSES_ID_NFT_FEES: '/api/v1/courses/:id/nft/fees',
  COURSES_ID_NFT_FEES_DEPOSIT: '/api/v1/courses/:id/nft/fees/deposit',
  COURSES_ID_NFT_FEES_WITHDRAW: '/api/v1/courses/:id/nft/fees/withdraw',
  ...
  OE_REFFERRAL_STATISTICS_ID: '/api/v1/oe-referrals/statistics/:id',
  SCHEDULES: '/api/v1/schedules',
  SCHEDULES_ID: '/api/v1/schedules/:id',
