      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            href: ADMIN_ROUTES.featuredContents,
          },
        ],
      },
      {
        id: 'terms-and-conditions',
        label: tDashboard('termsConditions.title'),
        icon: <HandHelping className="h-5 w-5" />,
        items: [
          {
            id: 'faq',
            label: tDashboard('termsConditions.faq'),
            icon: <CircleHelp className="h-5 w-5" />,
            href: ADMIN_ROUTES.faq,
          },
          {
            id: 'terms-privacy',
            label: tDashboard('termsConditions.termsAndPrivacy'),
            icon: <Handshake className="h-5 w-5" />,
            href: ADMIN_ROUTES.termsAndPrivacy,
          },
        ],
      },
      {
        id: 'statistic',
        label: tDashboard('statistic.title'),
        icon: <ClipboardList className="h-5 w-5" />,
        items: [
          {
            id: 'ai-course-statistic',
            label: tDashboard('statistic.aiCourseStatistic'),
            icon: <TrendingUp className="h-5 w-5" />,
            href: ADMIN_ROUTES.aiCourseStatistic,
          },
        ],
      },
    ],
