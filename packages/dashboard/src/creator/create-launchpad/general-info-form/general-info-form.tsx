import {
  type IGeneralInfoLaunchpadSchemaType,
  generalInfoLaunchpadSchema,
} from "@oe/api/schemas/launchpadSchema";
import { CREATE_LAUNCHPAD_FORM_ID } from "@oe/core/utils/constants";
import { LAUNCHPAD_ROUTES } from "@oe/core/utils/routes";
          ...
          {({ form }) => (
            <>
              <div className="grid w-full gap-5 lg:grid-cols-2">
                ...
                <div className="col-span-1 lg:col-span-2">
                  <CategoryAndLevel<IGeneralInfoLaunchpadSchemaType>
                    form={form}
                  />
                </div>
