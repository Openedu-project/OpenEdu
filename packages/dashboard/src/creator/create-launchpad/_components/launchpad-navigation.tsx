...
const buttonStyle = {
  ...
  outline: 'border border-primary bg-transparent rounded-xl text-primary hover:bg-primary/10 hover:text-primary',
...
const NavigationLaunchpad = ({ onPrevClick, onNextClick }: NavigationLaunchpadProps) => {
  return (
