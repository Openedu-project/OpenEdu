  ...
  return (
    <>
      <DashboardMainPageLayout
        breadcrumbs={[{ label: tDashboard('title') }, { label: tDashboard('detail'), disabled: true }]}
        dashboard="admin"
        header={
          <div>
            <h1 className="giant-iheading-semibold32 tracking-tight md:text-3xl">{tDashboard('detail')}</h1>
