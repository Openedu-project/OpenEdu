...
import { type AddCoursesCampaignSchemaType, addCoursesCampaignSchema } from '@oe/api/schemas/affiliateCampaignSchema';
...
export default function FormAffiliateCampaignCourseModal({ onSubmit, onClose }: IFormAffiliateCampaignCourseModal) {
