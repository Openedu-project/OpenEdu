      ...
      {(form) => {
        return (
          <>
            <FormFieldWithLabel
              name="playlist_link"
              label={tCourse("create.form.playlistLink")}
              required
            >
              <Input />
            </FormFieldWithLabel>
            <FormFieldWithLabel
              name="language"
              label={tCourse("create.form.language")}
            >
              <SelectLanguage />
            </FormFieldWithLabel>
            <FormFieldWithLabel
            ...
            {form.watch("summary_included") && (
              <FormFieldWithLabel
                name="tone"
                label={tCourse("create.form.tone")}
              >
            ...
            {form.watch("quiz_included") && (
              <FormFieldWithLabel
                name="quiz_type"
                label={tCourse("create.form.quizType")}
              >
            ...
            {form.watch("quiz_included") && (
              <FormFieldWithLabel
                ...
                label={tCourse("create.form.numberOfQuestion")}
              >
                <InputNumber min={1} />
              </FormFieldWithLabel>
            )}
