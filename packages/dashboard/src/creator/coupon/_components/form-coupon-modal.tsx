...
export default function CouponDialog({
  ...
  useEffect(() => {
    ...
    const formData: ICouponType = {
      ...
      fiat_discount_percentage: data.fiat_discount_percentage
        ? Number(data.fiat_discount_percentage)
        : undefined,
      crypto_discount_enabled: data.crypto_discount_enabled,
      crypto_discount_percentage: data.crypto_discount_percentage
        ? Number(data.crypto_discount_percentage)
        : undefined,
      maximum_total_usage: data.maximum_total_usage
        ? Number(data.maximum_total_usage)
        : undefined,
  ...
  const handleFormSubmit = useCallback(
    async (values: ICouponType) => {
      const submissionValue = {
        ...
        end_date:
          values.has_end_date && values.end_date
  ...
  const handleDiscountChange = useCallback(
    (
      ...
      field: ControllerRenderProps<ICouponType>
    ) => {
      ...
      >
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  {...field}
                  placeholder={tCouponForm("placeholderName")}
                />
              </FormControl>
              <FormMessage />
            </FormItem>
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  {...field}
                  placeholder={tCouponForm("placeholderDesc")}
                />
              </FormControl>
              <FormMessage />
            </FormItem>
                ...
                <InputCurrency
                  ...
                  value={
                    field.value === undefined || field.value === ""
                      ? 0
                      : Number.parseFloat(field.value.toString())
                  }
        ...
        <div className="block">
          <h3 className="font-semibold text-lg">
            {tCouponForm("paymentMethodSettings")}
          </h3>
                    ...
                    <FormControl>
                      <div className="relative">
                        <Input
                          ...
                          placeholder={tCouponForm(
                            "placeholderDiscountPercent"
                          )}
                          className="pr-10"
            ...
            <FormItem className="flex items-center justify-between">
              <div>
                <FormLabel className="text-base">
                  {tCouponForm("available")}
                </FormLabel>
                <p className="text-muted-foreground text-sm">
                  {tCouponForm("availableDescription")}
                </p>
              </div>
              <FormControl>
                <Switch
  ...
  return (
    <Dialog open onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          <DialogTitle>
            {isCreate ? t("createACouponForm") : t("editACouponForm")}
          </DialogTitle>
        </DialogHeader>
