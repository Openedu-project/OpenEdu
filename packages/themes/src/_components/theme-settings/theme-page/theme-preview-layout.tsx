...
const ThemePreviewLayout = ({ themeDefinition, themeName, children }: ThemeLayoutProps) => {
  ...
  return (
    <MainLayoutClient sidebarItems={sidebarItems} logo={headerProps?.logo as FileType} footerProps={footerConfig}>
      {children}
    </MainLayoutClient>
  );
};
