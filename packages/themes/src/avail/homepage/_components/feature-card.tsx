...
const FeatureCard = ({ image, textImg, description, className }: FeatureCardProps) => {
  return (
    <Card className={cn('flex h-full w-full flex-col items-center gap-4 rounded-lg bg-transparent p-4', className)}>
      <Image
        alt="Image"
        src={image?.url}
        height={288}
