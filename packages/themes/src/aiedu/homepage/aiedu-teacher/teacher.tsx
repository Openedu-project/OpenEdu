...
export interface AieduHomepageTeacherProps {
  title?: string;
  teachers?: ExpertProps[];
}

const AieduHomepageTeacher: SectionComponent<'homepage', 'aieduTeacher'> = ({ className, props }) => {
  const t = useTranslations('themePage.aiedu.homepage.aieduTeacher');
