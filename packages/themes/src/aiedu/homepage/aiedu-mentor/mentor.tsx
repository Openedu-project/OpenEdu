...
export interface AieduHomepageMentorProps {
  title?: string;
  mentors?: ExpertProps[];
}

const AieduHomepageMentor: SectionComponent<'homepage', 'aieduMentor'> = ({ className, props }) => {
  const t = useTranslations('themePage.aiedu.homepage.aieduMentor');
