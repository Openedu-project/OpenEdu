...
export interface AieduIntroductionMentorProps {
  title?: string;
  mentors?: ExpertProps[];
}

const AieduIntroductionMentor: SectionComponent<'introduction', 'aieduMentor'> = ({ className, props }) => {
  const t = useTranslations('themePage.aiedu.introduction.aieduMentor');

  return (
    <AieduLayoutSection className={cn('!pt-0 space-y-6', className)}>
...
export { AieduIntroductionMentor };
