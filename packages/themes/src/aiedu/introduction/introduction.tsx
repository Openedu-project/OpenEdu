...
const pageRender: PageRender = {
  introduction: {
    theme: undefined,
    aieduGoal: dynamic(() =>
      import("./aiedu-goal").then((mod) => mod.AieduIntroductionGoal)
    ),
    aieduVisionMission: dynamic(() =>
      import("./aiedu-vision-mission").then(
        (mod) => mod.AieduIntroductionVisionMission
      )
    ),
    ...
    aieduTrend: dynamic(() =>
      import("./aiedu-trend").then((mod) => mod.AieduIntroductionTrend)
    ),
    aieduBenefit: dynamic(() =>
      import("./aiedu-benefit").then((mod) => mod.AieduIntroductionBenefit)
    ),
  },
};

export const AieduIntroductionPage: SectionComponent<
  "introduction",
  "theme"
> = ({ props }) => {
  return (
