...
import { TrendCard, type TrendCardProps, type TrendColorType } from '../../_components/trend-card';
...
const AieduIntroductionTrend: SectionComponent<'introduction', 'aieduTrend'> = ({ props, className }) => {
  ...
  return (
    ...
    >
      ...
      <Title title={t('title')} className="mx-auto max-w-3xl pt-12 text-center md:pt-16 lg:pt-20" />
