...
const AieduIntroductionVisionMission: SectionComponent<'introduction', 'aieduVisionMission'> = ({ className }) => {
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-8 md:grid-cols-2">
        ...
        <StatementCard icon="sun" title={t('mission.title')} content={t('mission.content')} />
      </div>
    </AieduLayoutSection>
  );
};
