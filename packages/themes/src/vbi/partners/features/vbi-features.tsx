...
export interface VbiPartnersFeaturesProps extends InfoSectionProps {
  features: {
...
const VbiPartnersFeatures: SectionComponent<'partners', 'vbiPartnerFeatures'> = ({ className, t }) => {
  if (!t) {
    return null;
  }
  const features = [
