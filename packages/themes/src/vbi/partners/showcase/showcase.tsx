...
const VbiPartnersShowcase: SectionComponent<"partners", "vbiShowcase"> = ({
  props,
  className,
}) => {
  ...
  return (
    <div
      className={cn(
        "container space-y-4 bg-background py-8 md:space-y-8 md:py-12 lg:py-16",
        className
      )}
    >
      <InfoSection
...
export default VbiPartnersShowcase;
