...
const VbiHomepageCert: SectionComponent<'homepage', 'vbiCert'> = ({ props, className }) => {
  const t = useTranslations('themePage.vbi.homepage.vbiCert');

  return (
    <div
      className={cn('flex flex-col gap-2 rounded-lg bg-primary p-4 md:flex-row md:gap-4 md:p-6', className)}
      style={{
