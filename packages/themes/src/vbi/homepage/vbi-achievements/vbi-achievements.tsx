...
import { AchievementCard, type AchievementCardProps } from '../../_components/achievement-card';
...
const VbiHomepageAchievements: SectionComponent<'homepage', 'vbiAchievements'> = ({ props, className, t }) => {
  const achievements = [
    {
  ...
  return (
    <div className={cn('container mt-4 space-y-4 bg-background p-4 md:mt-12 md:space-y-8 md:p-8 lg:p-12', className)}>
      <InfoSection
        title={t?.('title')}
        titleSub={t?.('titleSub')}
        button={undefined}
...
export { VbiHomepageAchievements };
