...
const CreatorCard = ({
  ...
  return (
    <div
      className={`rounded-2xl bg-background p-8 shadow-sm transition-all duration-300 hover:shadow-md ${className}`}
    >
      ...
      <div className="relative">
        ...
        <p className="line-clamp-3 pl-6 text-foreground/80 leading-relaxed md:line-clamp-4 lg:line-clamp-6">
          {story}
        </p>
      </div>
    </div>
