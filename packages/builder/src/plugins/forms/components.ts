...
export default function (editor: Editor) {
  ...
  Components.addType(typeInput, {
    ...
    view: {
      ...
      //   console.log(1111);
      //   return createElement(cmp, props, this.createReactChildWrap());
      // },
      updateAttributes() {
  ...
  Components.addType(typeCheckbox, {
    ...
    view: {
      ...
      handleChecked() {
        (this.el as HTMLInputElement).checked = !!this.model.get('attributes')?.checked;
      },
    },
  });
  ...
  Components.addType(typeButton, {
    ...
    model: {
      ...
      init() {
        ...
        const chCnt = (tChild && (tChild as Component)?.is('textnode') && (tChild as Component)?.get('content')) || '';
