export const metadataMessage = {
  homepageMetadata: {
    title: 'OpenEdu - Blockchain & AI-Powered Education Platform',
    description:
      "Discover OpenEdu's innovative educational solutions using Blockchain, AI, and Gamification to enhance teaching and learning experiences with improved security and effectiveness for all users",
  },
  coursesMetadata: {
  ...
  launchpadMetadata: {
    ...
    description:
      "Experience collaborative learning through OpenEdu's Blockchain-powered Launchpad. Build a sustainable educational community while reducing costs and enhancing student engagement",
  },
  aiAgentMetadata: {
