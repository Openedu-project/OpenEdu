...
<pre><div class="flex justify-between border-b pb-2 opacity-50">
  ...
  <button 
    ...
    data-copy-button data-code="${safeEncodeURIComponent(originalCode)}" class="flex items-center justify-center h-6 w-6 border rounded-sm hover:bg-gray-100">
      ...
      <div class="flex justify-center">
        <div class="relative inline-block">
          ...
          <button
            ...
            class="p-2 flex gap-1 border rounded-sm bg-background absolute bottom-2 right-2"
          >
